Packaging and Deploying BtRecLib
...
2. Installing the BtRecLib Package

A. Go to the directory that contains the file setup.py and the subdirectory BtRecLib. If 
...
3. Using the BtRecLib Package

The BtRecLib package is on your Python path. To import it into a Python script or 
